...
const Navbar: React.FC = () => {
      ...
      items: [
        {
          ...
          description: "Bachelor's & Diploma programs",
        },
        {
          name: "Accounting & Finance",
          href: "/programs/accounting-finance",
          description: "CPA, ACCA, and finance courses",
        },
        {
          name: "Marketing Management",
          href: "/programs/marketing-management",
          description: "Digital marketing & brand strategy",
        },
        {
          name: "Human Resource Management",
          href: "/programs/human-resource",
          description: "HR analytics & people management",
        },
        {
          name: "Project Management",
          href: "/programs/project-management",
          description: "PMP, PRINCE2 certified",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Network admin & IT support",
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Manufacturing & robotics",
        },
        {
      ...
      items: [
        {
          ...
          description: "Registered nursing programs",
        },
        {
          name: "Clinical Medicine",
          href: "/programs/clinical-medicine",
        ...
        },
        {
          ...
          description: "Community health & epidemiology",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Travel & tour operations",
        },
        {
          name: "Culinary Arts",
  ...
  const mediaCenter: DropdownItem[] = [
    {
      name: "Gallery",
      href: "/media/gallery",
      description: "Campus life, events, and facilities",
      icon: "📸",
    },
    {
      name: "News",
    ...
    },
    {
      name: "Blogs",
      href: "/media/blogs",
      description: "Insights, articles, and student stories",
      icon: "✍️",
    },
    {
      name: "Events",
      ...
      items: [
        {
          ...
          href: "/admissions/registration-process",
          description: "Step-by-step enrollment guide",
        },
        {
          name: "Online Application",
          href: "/admissions/online-application",
          description: "Apply directly through our portal",
        },
        {
          name: "Entry Requirements",
          href: "/admissions/entry-requirements",
          description: "Minimum qualifications & documents",
        },
        {
      ...
      items: [
        {
          ...
          description: "Detailed program costs",
        },
        {
          name: "Fee Payment Batch",
          href: "/admissions/fee-payment-batch",
          description: "Payment schedules & batches",
        },
        {
          name: "Scholarships",
        ...
        },
        {
          ...
          description: "MPESA, bank, card payments",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: "Visa & accommodation info",
        },
        {
          name: "Student Portal",
    ...
    <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-[90vw] max-w-5xl bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 max-h-[70vh] overflow-y-auto">
        {programs.map((section, idx) => (
          <div
            key={idx}
            className="border-b md:border-b-0 md:border-r border-gray-100 last:border-r-0"
          >
      ...
      <div className="bg-linear-to-r from-indigo-50 to-purple-50 px-6 py-4 border-t border-gray-100">
        <Link
          href="/programs/all"
  ...
  const renderAdmissionsDropdown = () => (
    <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-[90vw] max-w-4xl bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50">
      ...
      <div className="bg-linear-to-r from-indigo-50 to-purple-50 px-6 py-4 border-t border-gray-100 flex justify-between items-center">
        <Link
          href="/admissions/online-application"
          ...
          <div className="flex justify-between items-center h-16 md:h-20">
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {link.name}
                        <svg
                          className={`w-4 h-4 transition-transform duration-200 ${activeDropdown === link.dropdownType ? "rotate-180" : ""}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
            ...
            <div className="flex gap-4">
              <div className="hidden md:block">
                <Link
                  href="/admissions/online-application"
                  className="inline-flex items-center gap-2 bg-linear-to-r from-red-600/90 to-red-700/90 hover:from-red-700 hover:to-red-800 text-white px-5 py-2.5 rounded-md text-sm font-semibold shadow-md transition-all duration-200 transform hover:scale-105"
                >
                  Apply Now
                </Link>
              </div>
              <Link
                href="/admin"
                className="inline-flex items-center gap-2 bg-linear-to-r from-red-600/90 to-red-700/90 hover:from-indigo-700 hover:to-indigo-800 text-white px-5 py-2 rounded-md text-sm font-semibold shadow-md transition-all duration-200 transform hover:scale-105"
              >
                Admin
              </Link>
            </div>
          ...
          <div className="md:hidden bg-white border-t border-gray-200 shadow-lg max-h-[80vh] overflow-y-auto">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <Link
                href="/admissions/online-application"
                onClick={() => setIsMobileMenuOpen(false)}
                className="block mt-4 w-full text-center bg-linear-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white px-4 py-3 rounded-full font-semibold"
              >
                Apply Now
              </Link>
            </div>
